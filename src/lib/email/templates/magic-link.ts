  ...
  render: (p, ctx) => {
    ...
    const cardHtml = `
      <div style="padding:28px 24px 0;text-align:center;">
        ...
        <h1 class="email-heading" style="margin:12px 0 0;font-size:20px;font-weight:700;letter-spacing:-0.3px;">${escapeHtml(
          HEADING
        )}</h1>
        <p class="email-body" style="margin:12px 0 0;font-size:14px;line-height:1.5;">${escapeHtml(PARAGRAPH)}</p>
