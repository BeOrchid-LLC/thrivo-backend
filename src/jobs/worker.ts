...
// double-fire scheduled sends. This is the runnable shell + wiring; the concrete
// job handlers land with their feature phases:
//   emails    → send-email (welcome, trial-ending −3d, cancellation)   [A2/A5]
...
function startWorker(name: QueueName): void {
  const worker = new Worker(
    ...
    async (job: Job) => {
      ...
      // TODO(A2/A5): dispatch to the real handler for this queue.
    },
