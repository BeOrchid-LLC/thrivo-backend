...
import { leadStatusEnum } from "./_enums";
...
export const emailCaptures = pgTable(
  "email_captures",
  {
    ...
    ownerAdminEmail: text("owner_admin_email"),
  ...
  (t) => ({
    ...
    statusOwnerIdx: index("email_captures_status_owner_idx").on(t.status, t.ownerAdminEmail),
  })
);
