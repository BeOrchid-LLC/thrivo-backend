 ...
 * - 0032 creates the pg_trgm extension and five CONCURRENTLY-built covering
 *   indexes for history search/filter/sort. All statements must run outside
 *   the drizzle transaction block.
 *
